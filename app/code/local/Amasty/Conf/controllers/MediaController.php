...
class Amasty_Conf_MediaController extends Mage_Core_Controller_Front_Action
{
    ...
    public function indexAction()
    {
        ...
        $this->getResponse()->setBody(
            $this->getLayout()->createBlock('catalog/product_view_media', 'product.info.media', array('template' => 'catalog/product/view/media.phtml'))->setParentBlock($parentBlock)->toHtml()
        );
    }
